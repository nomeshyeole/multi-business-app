...
export default function ElectronicsStore() {
  const products = [
    ...
    },
    {
      ...
      category: "Cameras",
      price: "$1299.99",
      description: "High-resolution DSLR camera with 4K video recording and advanced autofocus system.",
      image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1964&q=80"
    },
    {
      id: 3,
      ...
      image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80"
    },
    {
      id: 4,
      ...
      category: "Computers",
      price: "$1799.99",
      description: "High-performance gaming laptop with RTX graphics, fast refresh rate display, and RGB keyboard.",
          ...
          {products.map((product) => (
            <Card key={product.id} className="overflow-hidden bg-white shadow-lg rounded-2xl border border-blue-100">
              ...
              <CardContent className="p-6">
                ...
                <Badge variant="outline" className="bg-blue-100 text-blue-800 hover:bg-blue-200 mb-3">
                  {product.category}
                </Badge>
