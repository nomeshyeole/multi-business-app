...
export default function Services() {
  const services = [
    ...
    {
      title: "Smart Mall",
      description: "Modern shopping complex featuring specialty stores, diverse retail outlets, and entertainment zones with smart technology integration for enhanced shopping experience.",
